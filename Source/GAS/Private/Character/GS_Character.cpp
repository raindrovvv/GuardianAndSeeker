...
void AGS_Character::Tick(float DeltaTime) { Super::Tick(DeltaTime); }
...
FGenericTeamId AGS_Character::GetGenericTeamId() const { return TeamId; }
...
bool AGS_Character::IsDead() const { return bIsDead; }
...
void AGS_Character::SetCanHitReact(bool bCanReact) { CanHitReact = bCanReact; }

void AGS_Character::SetInvincible(bool bEnable) { bIsInvincible = bEnable; }
...
bool AGS_Character::ShowDecal() { return false; }
