...
/** 라이트 컬링 거리 (25m) - 던전 조명 유지 */
constexpr float LIGHT_CULL_DISTANCE = 2500.0f;
...
/** HP 위젯 기본 컬링 거리 (15m) */
constexpr float HP_WIDGET_CULL_DISTANCE = 1500.0f;

/** 스팀 닉네임 위젯 컬링 거리 (15m) */
constexpr float STEAM_NAME_WIDGET_CULL_DISTANCE = 1500.0f;
